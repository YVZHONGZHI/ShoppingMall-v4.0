# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2024-02-29 15:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(max_length=64, verbose_name='订单标题')),
                ('total_amount', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='订单总价')),
                ('order_status', models.IntegerField(choices=[(0, '未支付'), (1, '已支付')], default=0, verbose_name='订单状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, max_digits=7, verbose_name='商品单价')),
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='w.Goods')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='w.Order')),
            ],
        ),
        migrations.CreateModel(
            name='ShopCar',
